...
var create_client = function(token, config) {
    ...
    metrics.send_request = function(options, callback) {
        ...
        if (metrics.config.requestTimeout) {
            request_options.timeout = metrics.config.requestTimeout;
        }
            
        if (metrics.config.requestAgent) {
            request_options.agent = metrics.config.requestAgent;
        } else if (proxyAgent) {
